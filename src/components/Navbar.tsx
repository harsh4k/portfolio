...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-center gap-x-2 gap-y-1 font-mono text-[10px] uppercase tracking-[0.14em] select-none sm:flex-nowrap sm:gap-0">
        
        {/* Left Side Links */}
        <div className="flex justify-center gap-2 sm:order-1 sm:w-1/3 sm:justify-start">
          <button
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 text-center font-display text-sm tracking-normal text-[#161513] transition-opacity hover:opacity-75 focus:outline-none sm:order-2 sm:w-1/3 md:text-base"
          id="nav-anchor"
        >
        ...
        {/* Right Side Links */}
        <div className="flex justify-center gap-2 text-right sm:order-3 sm:w-1/3 sm:justify-end">
          <button
