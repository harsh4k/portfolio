          ...
          {categories.map((cat, i) => {
            ...
            return (
              ...
              >
                <Link
                  to={cat.path}
                  className={`group relative flex h-[320px] flex-col justify-between overflow-hidden rounded-[32px] border border-[#161513]/20 border-l-[6px] bg-[#EEE9DC] p-6 text-left no-underline transition-all hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(22,21,19,0.1)] md:p-8 ${cat.accent}`}
                >
